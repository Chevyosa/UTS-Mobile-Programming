package com.febriyann.myuts.home
...
import com.febriyann.myuts.R
import com.febriyann.myuts.adapter.ButtonAdapter
import com.febriyann.myuts.adapter.CategoryAdapter
import com.febriyann.myuts.data.DataButton
import com.febriyann.myuts.data.DataCategory
...
class HomeFrag : Fragment() {
    ...
    override fun onCreateView(
        ...
        val items = listOf(
            DataButton("Loose Weight", R.color.black, R.color.white),
            DataButton("Gain Weight", R.color.black, R.color.white),
            DataButton("Body Building", R.color.black, R.color.white),
            DataButton("Healthy", R.color.black, R.color.white)
        )
